...
const Navbar = () => {
  ...
  if (time >= 0 && time < 12) {
    greeting = <span>Good <span className="timeColor">Morning</span></span>;
  } else if (time >= 12 && time < 16) {
    greeting = <span>Good <span className="timeColor">Afternoon</span></span>;
  } else if (time >= 16 && time < 22) {
    greeting = <span>Good <span className="timeColor">Evening</span></span>;
  } else if (time >= 22 && time < 24) {
    greeting = <span>Good <span className="timeColor">Night</span></span>;
  }
    // search value
  ...
  return (
    <div className='navbar'>
      ...
      <div className="wrapper">
          ...
          />
          {searchValue && <CloseRoundedIcon className="close-icon" 
                    ...
                    <IconButton variant="contained" {...bindToggle(popupState)} className="icon">
                      ...
                      {({ TransitionProps }) => (
                        <Fade {...TransitionProps} timeout={350}>
                          <Paper>
                            <Typography sx={{ p: 2 }}>(1) Notification.</Typography>
                          </Paper>
                        </Fade>
                      )}
                      </Popper>
                    ...
                    >
                      ...
                      <MenuItem onClick={handleClose}>
                        <img
                            ...
                            alt="account avi"
                            className="avatar"
                            style={{ width: "25px", height: "25px", borderRadius: "50%", objectFit: "cover", marginRight: "10px" }}
                        />  My account
                      </MenuItem>
                      </Link>
                      <Divider />
                      <Link to="/account/new" style={{ textDecoration: "none", color: "#333" }}>
                      <MenuItem onClick={handleClose}>
                        <ListItemIcon>
                      ...
                      <Link to="/account/settings" style={{ textDecoration: "none", color: "#333" }}>
                      <MenuItem onClick={handleClose}>
                        <ListItemIcon>
